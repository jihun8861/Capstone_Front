const plantsData = [
    {
      ...
      attributes: ["잎을 감상하는", "빛이 적어도 되는","둥근모양","하트모양","길쭉한","무늬가 있는","잎 끝이 뾰족한","잎이 두꺼운"],
      description: 
      `알로카시아 프라이덱은 'Green Velvelt Alocasia'라고도 불리우며, 
      아시아의 아열대 지역과 호주 동부에서 온 식물이랍니다. 
      하트모양의 잎은 보드러운 벨벳을 만지는 듯한 느낌을 주고, 
      벨벳 질감의 진한 녹색잎에 흰색 잎맥이 대비되어 
      집 안에 하나만 있어도 포인트가 확실하게 되는 식물이에요. 
      빛이 드는 곳에서 보면 꼭 형광처럼 빛나는 착각마저 들게해요. 
      아주 매력적인 식물이지만 적절한 환경 조건을 맞춰주지 않으면 
      잎에 금세 티가 나 키우기는 다소 어려운 편에 속하는 식물이랍니다. 
      프라이덱은 밝은 간접광과 따뜻한 온도, 그리고 촉촉한 습도를 좋아해요.`,
    ...
    },
    {
      ...
      },
      {
        ...
        description: 
        `드라세나 드라코는 공기정화 능력이 뛰어나고 관리가 쉬운 실내식물입니다. 
      ...
      },
      {
        ...
        description: 
        `알로카시아 블랙벨벳은 벨벳 같은 질감의 검은 잎이 매력적인 식물입니다. 
        빛이 적은 곳에서도 잘 자라며, 물을 자주 주어야 합니다.`,
        waterFrequency: ["평균 주 1~2회", "흙이 마르면 듬뿍 주세요"], // 물주기 횟수 [최소, 최대]
        sunlight: ["반양지", "하루 2~3시간 정도의 은은한 햇빛이 필요해요"], // 햇빛 [최소, 최대]
        humidity: ["50~70%", "주변 공기를 촉촉하게 관리해주세요"], // 습도 [최소, 최대]
      ...
      },
      {
        ...
        description: 
        `피쉬본 선인장은 물고기 뼈 모양의 독특한 잎을 가진 식물로, 
        실내에서 키우기 좋습니다. 
