const plantsData = [
  {
    ...
    description: `알로카시아 프라이덱은 벨벳 같은 질감의 짙은 녹색 잎과 흰색 잎맥이 돋보이는 매력적인 아열대 식물입니다. 밝은 간접광, 따뜻한 온도, 촉촉한 습도를 좋아하며 실내에서 포인트가 되는 존재감을 가집니다. 환경 조건이 맞지 않으면 관리가 까다롭지만, 독특한 아름다움으로 인테리어에 생기를 더합니다.`,
